            ...
            <div class="mx-auto max-w-xl lg:max-w-screen-xl">
              <div class="mb-16 lg:mb-0 lg:max-w-lg">
                <div class="mb-6 max-w-xl">
                  <h2 class="mb-6 max-w-lg font-sans text-3xl font-bold tracking-tight text-slate-100 sm:text-5xl sm:leading-snug">
                    An inspiring new future <br />
                    for
                    <span class="inline-block text-cyan-500 ml-3.5">
                      Web 3.0
                    </span>
                  </h2>
                ...
                <div class="flex items-center">
                  ...
                  <a
                    href="/"
                    aria-label=""
                    class="inline-flex items-center font-semibold text-cyan-600 transition-colors duration-200 hover:text-cyan-400"
                  >
                    Learn more
                  </a>
                </div>
